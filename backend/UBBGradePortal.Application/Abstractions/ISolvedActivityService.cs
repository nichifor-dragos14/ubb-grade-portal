...
{
    Task<PaginatedProfessorSolvedActivityDto> GetAllByStatusForProfessorCourses(int pageNumber, int pageSize, SolvedActivityStatusFilter status, Guid loggedUserId, CancellationToken cancellationToken);
