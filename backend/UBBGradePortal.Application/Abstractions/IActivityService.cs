...
public interface IActivityService
{
    ...
    Task<PaginatedProfessorSolvedActivityDto> GetAllSolvedActivitiesProfessor(int pageNumber, int pageSize, Guid loggedUserId, CancellationToken cancellationToken);
