        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_CourseDomains_CourseDomainId",
                        column: x => x.CourseDomainId,
                        principalTable: "CourseDomains",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolvedActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SolvedActivities_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SolvedActivities_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CourseDomainId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolvedActivities_ActivityId",
                table: "SolvedActivities",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_SolvedActivities_UserId",
                table: "SolvedActivities",
                column: "UserId");
        }
